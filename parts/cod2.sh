...
# lnxded
cp "$MAINDIRECTORY/cod2_lnxded/1.0/cod2_lnxded" "$HOME/cod2_1_0/cod2_lnxded"
chmod 500 ~/cod2_1_0/cod2_lnxded

cp "$MAINDIRECTORY/cod2_lnxded/1.2/cod2_lnxded" "$HOME/cod2_1_2/cod2_lnxded"
chmod 500 ~/cod2_1_2/cod2_lnxded

cp "$MAINDIRECTORY/cod2_lnxded/1.3/cod2_lnxded" "$HOME/cod2_1_3/cod2_lnxded"
...
then
	cp "$MAINDIRECTORY/cod2_lnxded/1.2/pb" "$HOME/cod2_1_2/pb" -R
	cp "$MAINDIRECTORY/cod2_lnxded/1.3/pb" "$HOME/cod2_1_3/pb" -R
fi
